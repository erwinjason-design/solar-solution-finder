...
## Decision Tree & Assessment Flow — v0.6 | March 2026
...
School type auto-sets: Boarding → 100%, 7d. Day → 85%, 5d. Mixed → 90%, 6d.
...
| LPG cylinders/mo | Optional | Auto-estimates monthly cost if entered |
...
## C6 — CO2
LPG: 2.98 kg/kg. Biomass: 1.83 kg/kg. Electric: 0.4 kg/kWh. Mixed: 50/50.
...
All fully translated (EN + SW). Results page mobile-responsive.

1. **Header** — school name, diners, meals/year, GHI
2. **Baseline** — monthly fuel cost, fuel cost/meal, CO₂/year (stacked on mobile)
3. **Recommendation** — template paragraph
4. **"What to do next"** — vendor tap-to-call, "share with your bursar"
5. **Comparison** — stacked cards (mobile) or table (desktop). Plain language labels.
6. **Energy priority** — only for poor/no electricity. Condensed note + expandable details.
7. **Solution details** — collapsible technical specs, induction notice, cooking tips
8. **Schedule** — collapsible solar/backup flags per meal
9. **Caveats** — collapsible
...
See `assumptions-register-v2-26mar2026.md` for full register.

Key blockers: MJ/meal multipliers (🔴), PV vendor quotes (🔴), Swahili review (🟡).

---

*v0.6 — March 2026. Mobile responsive, plain language, collapsible results, full translation, UX review implementation.*
